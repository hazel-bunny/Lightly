...
namespace Lightly
{
        ...
        : DecorationButton(type, decoration, parent), m_animation(new QVariantAnimation(this))
    {
        ...
        connect(decoration->settings().data(),
        ...
        if (auto d = qobject_cast<Decoration *>(decoration)) {
            ...
            switch (type) {
                case DecorationButtonType::Close:
                    ...
                    QObject::connect(d->client().data(),
                                     &KDecoration2::DecoratedClient::closeableChanged,
                                     b,
                                     &Lightly::Button::setVisible);
                    break;
    ...
    QColor Button::foregroundColor() const
    {
        ...
        else if ((type() == DecorationButtonType::KeepBelow || type() == DecorationButtonType::KeepAbove
        ...
        if (isPressed()) {
            ...
            if (type() == DecorationButtonType::Close) {
                if (d->internalSettings()->outlineCloseButton()) {
                    return KColorUtils::mix(d->fontColor(),
