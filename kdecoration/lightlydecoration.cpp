...
namespace Lightly
{
    ...
    void Decoration::init()
    {
        ...
        // buttons
        connect(s.data(),
                &KDecoration2::DecorationSettings::spacingChanged,
                this,
        ...
        connect(s.data(),
                &KDecoration2::DecorationSettings::reconfigured,
                SettingsProvider::self(),
                &SettingsProvider::reconfigure,
                Qt::UniqueConnection);
        connect(s.data(),
                &KDecoration2::DecorationSettings::reconfigured,
                this,
        ...
        connect(c,
                &KDecoration2::DecoratedClient::adjacentScreenEdgesChanged,
                this,
    ...
    {
        auto c = client().data();
        if (m_sizeGrip) { m_sizeGrip->setVisible(c->isResizeable() && !isMaximized() && !c->isShaded()); }
    }
    ...
    void Decoration::updateButtonsGeometry()
    {
        ...
        const int verticalOffset = (isTopEdge() ? s->smallSpacing() * Metrics::TitleBar_TopMargin : 0)
            ...
            foreach(const QPointer<KDecoration2::DecorationButton> &button,
        ...
        if (!m_rightButtons->buttons().isEmpty()) {
            ...
            if (isRightEdge()) {
                ...
                m_rightButtons
                    ->setPos(QPointF(size().width() - m_rightButtons->geometry().width() - hPadding - borderRight(),
                                     vPadding));
            }
        }
    ...
    void Decoration::paint(QPainter *painter, const QRect &repaintRegion)
    {
        ...
        if (!c->isShaded()) {
            ...
            if (s->isAlphaChannelSupported()) {
                painter
                    ->drawRoundedRect(rect(), m_internalSettings->cornerRadius(), m_internalSettings->cornerRadius());
            }
    ...
    void Decoration::paintTitleBar(QPainter *painter, const QRect &repaintRegion)
    {
        ...
        if (isMaximized() || !s->isAlphaChannelSupported()) {
            ...
            if (qGray(this->titleBarColor().rgb()) < 130 && m_internalSettings->drawHighlight()) {
                ...
                p.drawRoundedRect(copy.adjusted(0, 1, 0, 0),
                                  m_internalSettings->cornerRadius(),
                                  m_internalSettings->cornerRadius());
    ...
    {
        return hideTitleBar() ? borderTop() : borderTop()
            - settings()->smallSpacing() * (Metrics::TitleBar_BottomMargin + Metrics::TitleBar_TopMargin) - 1;
    }
