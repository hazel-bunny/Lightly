...
namespace Lightly
{
    ...
    public:
        ...
        SubControl hitTestComplexControl(ComplexControl,
    ...
    private:
        ...
        */
        ...
        //* pointer to control specialized function
        using StyleComplexControl = std::function<bool(const Style &,
                                                       const QStyleOptionComplex *,
                                                       QPainter *,
                                                       const QWidget *)>;
    ...
    bool Style::hasParent(const QWidget *widget, const char *className) const
    {
        ...
        while ((widget = widget->parentWidget())) { if (widget->inherits(className)) { return true; }}
    ...
    bool Style::hasParent(const QWidget *widget) const
    {
        ...
        while ((widget = widget->parentWidget())) { if (qobject_cast<const T *>(widget)) { return true; }}
